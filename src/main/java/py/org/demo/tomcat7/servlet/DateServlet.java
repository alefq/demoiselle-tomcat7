package py.org.demo.tomcat7.servlet;
...
import py.org.demo.tomcat7.business.DateBC;
...
public class DateServlet extends HttpServlet implements Serializable {
	...
	protected void doGet(HttpServletRequest request,
		...
		out.println("La fecha en America/New_York es: "
				+ service.getCurrentDate("America/New_York"));
		out.close();
	}
}
